 ...
 *
 * This class uses a built-in static method to perform the path search via Dijkstra and uses a
 * simple version of behavior trees to determine its next action.
 */
public class AdvancedMurderBot implements AdvancedBot {
  ...
  public static class GameContext {
    ...
    public GameContext(AdvancedGameState gameState,
  ...
  public static synchronized Map<GameState.Position, DijkstraResult> dijkstraSearch(
  ...
  public AdvancedMurderBot() {
    ...
    UnattendedMineDecisioner unattendedMineDecisioner =
        new UnattendedMineDecisioner(squatDecisioner);
    BotTargetingDecisioner botTargetingDecisioner =
        new BotTargetingDecisioner(unattendedMineDecisioner);
    EnRouteLootingDecisioner enRouteLootingDecisioner =
        new EnRouteLootingDecisioner(botTargetingDecisioner);

    HealDecisioner healDecisioner = new HealDecisioner();
    CombatOutcomeDecisioner combatOutcomeDecisioner =
        new CombatOutcomeDecisioner(botTargetingDecisioner, botTargetingDecisioner);
    CombatEngagementDecisioner combatEngagementDecisioner =
        new CombatEngagementDecisioner(combatOutcomeDecisioner, healDecisioner);
    BotWellnessDecisioner botWellnessDecisioner =
        new BotWellnessDecisioner(enRouteLootingDecisioner, combatEngagementDecisioner);
